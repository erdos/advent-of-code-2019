(defn exec-intcode [code pos] (case (code pos) 99 (reduced code) 1 (assoc code (code (+ pos 3)) (+ (code (code (+ 1 pos))) (code (code (+ 2 pos))))) 2 (assoc code (code (+ pos 3)) (* (code (code (+ 1 pos))) (code (code (+ 2 pos)))))))

(defn intcode [code] (first (reduce exec-intcode (assoc (vec code) 1 12 2 2) (range 0 (count code) 4))))
